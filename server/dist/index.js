...
import { SocketEvent, SkillType, } from '@yubifuru/shared/types.js';
const app = express();
...
function getRandomZoneDuration() {
...
function createPlayerState(socketId, username) {
    return {
        id: socketId,
        username,
        hp: 100,
...
io.on('connection', (socket) => {
    ...
    socket.on(SocketEvent.JOIN_GAME, (payload) => {
    ...
    socket.on(SocketEvent.USE_SKILL, (payload) => {
